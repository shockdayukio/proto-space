...
describe PrototypesController do
  ...
  describe 'with an user login' do
    ...
    context 'GET #new' do
      let(:placeholders)  { %W(Web\sdesign UI Application) }
      let(:new_prototype) { build(:new_prototype) }
      ...
      it "assigns an array of tag examples to @placeholders" do
        expect(assigns(:placeholders)).to eq placeholders
      end
    ...
    context 'POST #create' do
      ...
      context '@prototype can be saved' do
        ...
        it "adds a flash message" do
          expect(flash[:notice]).to include "Succeeded to publish your prototype"
        end
      end
  ...
  # describe 'without an user login' do
  #   context 'GET #index' do
  #     let(:index_prototypes) { Prototype.page(params[:page]).per(Prototype::NUMBER_OF_DISPLAYED_PROTOTYPES) }

  #     before :each do
  #       get :index
  #     end

  #     it "assigns an array of requested prototypes to @prototypes" do
  #       expect(assigns(:prototypes)).to eq index_prototypes
  #     end
  ...
  #     it "assigns an the requested prototype to @prototype" do
  #       expect(assigns(:prototype)).to eq prototype
  #     end

  #     it "assigns comments on the prototype to @comments" do
  #       expect(assigns(:comments)).to eq prototype.comments
  #     end
